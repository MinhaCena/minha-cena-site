import styles from '../components/Terms/styles.module.scss';

export default function Termos(){
    return(
        <>
            <header className={styles.navbar}>
                <img src="http://localhost:3000/img/Vector.png" alt='logo'/>
                <form className={styles.search_box}>
                    <img src="http://localhost:3000/img/tabler_search.png"/>
            ...
            <aside className={styles.sidebar}>
                ...
                <ul className={styles.sidebar_box}>
                    <img className={styles.sidebar_icon} src="http://localhost:3000/img/arrow.png"/>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.content_box}>
                    ...
                    <h1 className={styles.title}>1. Nossos valores:</h1>
                    ...
                    <h1 className={styles.title}>2. Nossa plataforma é gratuita para todos os usuários:</h1>
                    ...
                    <div className={styles.content_text}>
                        ...
                        <b>2.1. Responsabilidades MinhaCena.Org:</b><br/>
                        ...
                        <b>2.2. Responsabilidades Escolas:</b><br/>
                        
                        <p>• Orientar pais de alunos sobre o voluntariado das atividades na plataforma;</p>
                        
                        <b><p>2.3. Responsabilidades ilustradores voluntários(as):</p></b>
                    ...
                    <h1 className={styles.title}>3. Perfis:</h1>
                    ...
                    <div className={styles.content_text}>Conforme informado acima, todos os perfis e vagas de voluntariado no site 
                        ...
                        <br/>
                        <b><p>3.1. Perfis dos Ilustradores:<br/></p></b>
                        ...
                        <b>3.2.1. Informações relevantes para inserção da escola na plataforma;</b>
                        ...
                        <b>3.2.2. Regras gerais para aprovação;<br/></b>
                        ...
                        <b>3.2.3. Sobre direitos autorais;<br/></b>
                    ...
                    <h1 className={styles.title}>4. Lei Geral de Proteção de Dados:</h1>
